...
(() => {
/*!************************************!*\
  !*** ./ExternalAssets/MgtDrugs.js ***!
  \************************************/
__webpack_require__.g.axios = __webpack_require__(/*! ./sale/axios */ "./ExternalAssets/sale/axios.js");
__webpack_require__.g.DisplayTextHere = $('.DisplayTextHere');
window.addEventListener('DOMContentLoaded', function (event) {
  $(document).on("click", ".ViewDesc", function () {
    var Desc = $(this).data("desc");
    DisplayTextHere.html(Desc);
    $('.editorme').trumbowyg(); // $('.editorme').trumbowyg();
  });
});
})();
