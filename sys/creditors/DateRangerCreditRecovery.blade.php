...
<div class="card-body shadow-lg pt-3 bg-light table-responsive">
    <div class="rowssss">
        <form action="{{ route('AcceptDateRangerCreditRecovery') }}" method="POST">
            <div class="row">
                ...
                <div class="mb-3 col  py-5   my-5">
                    ...
                    <select required name="FromMonth"
                        ...
                        @isset($Creditors)
                            ...
                            @foreach ($Creditors->unique('Month') as $data)
                ...
                <div class="mb-3 col  py-5   my-5">
                    ...
                    <select required name="ToMonth"
                        ...
                        @isset($Creditors)
                            ...
                            @foreach ($Creditors->unique('Month') as $data2)
                ...
                <div class="mb-3 col  py-5   my-5">
                    ...
                    <select required name="Year"
                        ...
                        @isset($Creditors)
                            ...
                            @foreach ($Creditors->unique('Year') as $data3)
