<div class="modal" tabindex="-1" id="ModalSelectDrug">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-dark">
                <h5 class="modal-title text-white fw-bolder"
                    id="staticBackdropLabel">Select item
                    to add to cart
                </h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <!--begin::Input-->
                        <input type="text"
                            class="form-control IntOnlyNow QtySelected"
                            placeholder="" value="" />
                        <!--end::Input-->
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button"
                    class="btn btn-dark SelectExistingDrugButton">Save
                    Changes</button>
            </div>
        </div>
    </div>
