 ...
 <div class="card-body pt-3 bg-light shadow-lg table-responsive">
     {!! Alert($icon = 'fa-info ', $class = 'alert-danger ', $Title = 'To restock a drug, Click create stock pile', $Msg = null) !!}
 </div>
 <div class="card-body pt-3 bg-light shadow-lg table-responsive">
                 ...
                 @foreach ($Drugs as $data)
                     <tr>
                         ...
                         <td class="fw-bolder text-light bg-dark">
                             {{ $data->QtyAvailable }} {{ $data->Dunit }}</td>
