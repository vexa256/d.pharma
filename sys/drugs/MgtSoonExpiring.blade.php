 ...
 @isset($Expired)
     <div class="card-body pt-3 bg-light shadow-lg table-responsive">
         {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Track and manage expired stock items', $Msg = null) !!}
     </div>
 @endisset

 @isset($Soon)
     <div class="card-body pt-3 bg-light shadow-lg table-responsive">
         {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Track soon expiring stock items', $Msg = null) !!}
     </div>
 @endisset
 ...
 @isset($Consumable)
     <div class="card-body pt-3 bg-light shadow-lg table-responsive">
         {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Track  expired consumables in stock', $Msg = null) !!}
     </div>
 @endisset
 <div class="card-body pt-3 bg-light shadow-lg table-responsive">
