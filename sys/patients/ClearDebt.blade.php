                ...
                @foreach ($Credit as $data)
                    <tr>
                        ...
                        <td class="bg-dark text-light">
                            {{ number_format($data->Outstanding) }} UGX</td>
                        <td>
                            ...
                            <form action="{{ route('RecordDebtPay') }}" class="row"
                                ...
                                <div class="row">
                                    <div class="mt-3  mb-3 col-md-6 ">
                                        <label id="label" for=""
                                            class=" required  form-label">Amount Paid By
                                            Patient</label>
                                    ...
                                    <div class="mb-3 col-md-6 pt-3">
                                        ...
                                        <select required name="PaymentMethod" class="form-select"
                    ...
                    <table
                        ...
                        <tbody> @isset($credit_payment_logs)
                                @foreach ($credit_payment_logs as $dat)
                                    <tr>
                                        <td class="bg-dark text-light">
                                            {{ number_format($dat->AmountPaid) }} UGX</td>

                                        <td class="bg-dark text-light">
                                            {{ $dat->PaymentMethod }}</td>

                                        <td class="bg-dark text-light">
                                            {{ number_format($dat->Outstanding) }} UGX</td>
