        ...
        <tbody> @isset($Credit)
                @foreach ($Credit as $data)
                    <tr>
                        ...
                        <td>
                            <a data-bs-toggle="modal" href="#New{{ $data->id }}"
                ...
                <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
                    <div class="modal-content">
                        <div class="modal-header bg-gray">
                            <h5 class="modal-title"> Register Balance Depletion for the patient
                        ...
                        <div class="modal-body ">
                            ...
                            <form action="{{ route('DepletePatientBalance') }}"
                                class="row" method="POST"> @csrf
                                <div class="row">
                                    <div class="mt-3  mb-3 col-md-12  ">
                                        <label id="label" for=""
                                            class=" required  form-label">Amount to deduct from
                                            patient balance</label>
                                        <input type="text" name="AmountPaid"
                                            class="form-control IntOnlyNow" placeholder="" id="">
                                    </div>
                    ...
                    <table
                        ...
                        <tbody> @isset($credit_payment_logs)
                                @foreach ($credit_payment_logs as $dat)
                                    <tr>
                                        <td class="bg-dark text-light">
                                            {{ number_format($dat->AmountUsed) }} UGX</td>

                                        <td class="bg-dark text-light">
                                            {{ number_format($dat->Balance) }} UGX</td>
