 ...
 <div class="card-body pt-3 bg-light shadow-lg table-responsive">
     {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Manage settings for the selected patient', $Msg = null) !!} </div>
 <div class="card-body pt-3 bg-light shadow-lg table-responsive">
     <a href="{{ url()->previous() }}
        " class="btn mx-1 float-end   mb-2 btn-sm btn-danger">
         <i class="fa fa-arrow-circle-left me-1" aria-hidden="true"></i>
                 ...
                 <tr>
                     ...
                     <td> <a data-bs-toggle="modal"
                             ...
                             href="#Allergies{{ $data->id }}"> <i
                                 class="   fas fa-binoculars" aria-hidden="true"></i>
                     ...
                     <td> <a data-bs-toggle="modal"
                             ...
                             href="#Keen{{ $data->id }}"> <i
                                 class="   fas fa-people-carry" aria-hidden="true"></i>
