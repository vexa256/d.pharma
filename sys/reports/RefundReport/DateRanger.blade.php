...
<div class="card-body shadow-lg pt-3 bg-light table-responsive">
    <div class="">
        <form action="{{ route('RefundReportAccept') }}" method="POST">
            <div class="row">
                ...
                <div class="mb-3 col  py-5   my-5">
                    ...
                    <select required name="FromMonth"
                        ...
                        @isset($Reports)
                            ...
                            @foreach ($Reports->unique('RefundMonth') as $data)
                                <option value="{{ $data->RefundMonth }}">
                                    <?php
                ...
                <div class="mb-3 col  py-5   my-5">
                    ...
                    <select required name="ToMonth"
                        ...
                        @isset($Reports)
                            ...
                            @foreach ($Reports->unique('RefundMonth') as $data2)
                                <option value="{{ $data2->RefundMonth }}">
                                    <?php

                                    $monthNum = $data2->RefundMonth;
                                    $dateObj = DateTime::createFromFormat('!m', $monthNum);
                                    echo $dateObj->format('F');
                ...
                <div class="mb-3 col  py-5   my-5">
                    ...
                    <select required name="Year"
                        ...
                        @isset($Reports)
                            ...
                            @foreach ($Reports->unique('RefundYear') as $data3)
                                <option value="{{ $data->RefundYear }}">
                                    {{ $data3->RefundYear }}</option>
                            @endforeach
                        @endisset
